...
const Slider = React.forwardRef(function Slider(props, ref) {
  ...
  return React.createElement(Component, _extends({
    ref: handleRef,
    className: clsx(classes.root, className, disabled && classes.disabled, marks.length > 0 && marks.some(mark => mark.label) && classes.marked, orientation === 'vertical' && classes.vertical),
